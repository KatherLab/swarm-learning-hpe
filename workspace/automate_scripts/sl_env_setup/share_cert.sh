...
sudo scp $username@"$target_host":/opt/hpe/swarm-learning-hpe/cert/ca/capath/ca-DRESDEN_T-cert.pem /opt/hpe/swarm-learning-hpe/cert/ca/capath
#sudo chmod 777 /opt/hpe/swarm-learning-hpe/cert/ca/capath/{!ca-DRESDEN_T,}*"-cert.pem"
