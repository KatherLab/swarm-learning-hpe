...
base_dir = '/mnt/swarm_alpha/KIRC_4grading/train_val_test/'  # Replace with your actual base directory path
...
model.fc = nn.Linear(num_ftrs, 4)  # Update for 4 classes
...
criterion = nn.CrossEntropyLoss()  # Update to CrossEntropyLoss for multi-class classification
