...
'''
for type in ['KIRC', 'KIRP']:
    for step in range(2000, 354000, 2000):
        image_dir = f'/mnt/swarm_beta/sbm_evaluation/conditional_cut/{type}/image_grid_{step}'
        feature_dir = f'/mnt/swarm_beta/sbm_evaluation/conditional_cut/{type}_ctrans/image_grid_{step}'
