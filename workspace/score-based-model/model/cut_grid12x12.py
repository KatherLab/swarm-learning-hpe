...
if __name__ == "__main__":
    grid_image_dir = '/mnt/swarm_beta/sbm_evaluation/uncon_sample_large/'  # Path to your grid image
    ...
    for grid_image_name in os.listdir(grid_image_dir):
        ...
        save_dir = '/mnt/swarm_beta/sbm_evaluation/uncon_sample_large_cut/'  # Directory to save the cropped images
